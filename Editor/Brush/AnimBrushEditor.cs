...
namespace SpicyTilemapEditor
{
    ...
    {
        [MenuItem("Assets/Create/SpicyTilemapEditor/Brush/AnimBrush", priority = 50)]
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (m_brush.AnimFrames.Count == 0)
                m_brush.AnimFrames.Add(
                    new AnimBrush.TileAnimFrame
                    {
                        tileId = Tileset.k_TileId_Empty,
