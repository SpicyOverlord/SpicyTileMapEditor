    ...
    public class TilePropertiesControl
    {
        ...
        private void DisplayAutotiling()
        {
            ...
            else
            {
                ...
                selectedTile.autotilingGroup = TilesetEditor.DoGroupFieldLayout(Tileset, "Group", selectedTile.autotilingGroup);
                ...
                if (EditorGUI.EndChangeCheck())
                {
                    ...
                    if (isMultiselection)
                    {
                        ...
                        {
                            Tile tile = Tileset.Tiles[(int)(Tileset.TileSelection.selectionData[i] & Tileset.k_TileDataMask_TileId)];
                            tile.autotilingGroup = selectedTile.autotilingGroup;
                        }
                    }
                    EditorUtility.SetDirty(Tileset);
                }
