...
#pragma warning disable 618
            if ( (RandomTileList == null || RandomTileList.Count == 0) && RandomTiles?.Count > 0)
            {
...
#pragma warning restore 618
        ...
        public float GetSumProbabilityFactor() => RandomTileList.Sum(x => x.probabilityFactor);

        #region IBrush

        public override uint PreviewTileData() => 
            RandomTileList.Count > 0 ? RandomTileList[0].tileData : Tileset.k_TileData_Empty;
