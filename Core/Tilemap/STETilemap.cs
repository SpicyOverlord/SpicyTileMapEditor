...
namespace SpicyTilemapEditor
{
    ...
    [AddComponentMenu("SpicyTilemapEditor/STETilemap", 10)]
    ...
    public class STETilemap : MonoBehaviour
    {
        ...
        {
            get => m_allowPaintingOutOfBounds;
        ...
        /// </summary>
        public int MinGridX => m_minGridX /*set { m_minGridX = Mathf.Min(0, value); }*/;

        /// <summary>
        /// Returns the minimum vertical grid position of the tilemap area
        /// </summary>
        public int MinGridY => m_minGridY /*set { m_minGridY = Mathf.Min(0, value); }*/;

        /// <summary>
        /// Returns the maximum horizontal grid position of the tilemap area
        /// </summary>
        public int MaxGridX => m_maxGridX /*set { m_maxGridX = Mathf.Max(0, value); }*/;

        /// <summary>
        /// Returns the maximum vertical grid position of the tilemap area
        /// </summary>
        public int MaxGridY => m_maxGridY /*set { m_maxGridY = Mathf.Max(0, value); }*/;

        /// <summary>
        /// Returns the horizontal size of the grid in tiles
        /// </summary>
        public int GridWidth => m_maxGridX - m_minGridX + 1;

        /// <summary>
        /// Returns the vertical size of the grid in tiles
        /// </summary>
        public int GridHeight => m_maxGridY - m_minGridY + 1;

        /// <summary>
        /// Returns the parent tilemap group the tilemap is children of
        /// </summary>
        public TilemapGroup ParentTilemapGroup => m_parentTilemapGroup;
        ...
        public ChunkRendererPropertiesData ChunkRendererProperties => m_chunkRendererProperties;
        ...
        [Tooltip(
            "Default: is faster, but less precise with PolygonCollider2D. In general, use Clipper only if Default is not working for PolygonCollider2D.")]
        ...
        public void RefreshChunksSortingAttributes()
        {
            ...
            // (valueIter as IDisposable)?.Dispose();
        }
        ...
        [SerializeField] private bool m_pixelSnap = true;
        [SerializeField] private SpriteMaskInteraction m_maskInteraction;
        ...
        private void OnTransformParentChanged() => m_parentTilemapGroup = GetComponentInParent<TilemapGroup>();
        ...
        private void DoDrawGizmos()
        {
            ...
            if (ShowGrid)
            {
                ...
                if (HandleUtility.GetHandleSize(rayCamToPlane.GetPoint(distCamToTilemap)) <= 20f)
                {
                    // draw tile cells
            ...
            EBlendMode blendMode = EBlendMode.AlphaBlending)
        {
            ...
            if (m_allowPaintingOutOfBounds || (gridX >= m_minGridX && gridX <= m_maxGridX && gridY >= m_minGridY &&
                                               gridY <= m_maxGridY))
            {
        ...
        public void SetTileData(int gridX, int gridY, uint tileData)
        {
                                               ...
                                               gridY <= m_maxGridY))
            {
                ...
                OnTileChanged?.Invoke(this, gridX, gridY, tileData);
#if UNITY_EDITOR
        ...
        /// </summary>
        /// <param name="vLocalPos"></param>
        public void Erase(Vector2 vLocalPos) => SetTileData(vLocalPos, Tileset.k_TileData_Empty);
        ...
        /// <param name="gridX"></param>
        /// <param name="gridY"></param>
        public void Erase(int gridX, int gridY) => SetTileData(gridX, gridY, Tileset.k_TileData_Empty);
        ...
        public uint GetTileData(Vector2Int vGridPos) =>
            GetTileData(vGridPos.x, vGridPos.y);
        ...
        /// <param name="vLocalPos"></param>
        /// <returns></returns>
        public bool IsPositionInsideTilemap(Vector2 vLocalPos) => MapBounds.Contains(vLocalPos);
        ...
        public void UpdateMeshImmediate()
        {
            ...
            foreach (var chunk in s_chunkList)
        ...
        public int GetChunkCount() => m_dicChunkCache.Count;

        public TilemapChunk GetChunk(int index) => m_dicChunkCache[index] as TilemapChunk;
        ...
        System.Collections.Specialized.OrderedDictionary m_dicChunkCache = new();
        ...
        private TilemapChunk GetOrCreateTileChunk(int gridX, int gridY, bool createIfDoesntExist = false)
        {
            ...
            if (tilemapChunk == null && createIfDoesntExist)
            {
                ...
                //NOTE: note the flags inheritance. BrushBehaviour object is not saved, so chunks are left orphans unless this inheritance is done
                chunkObj.hideFlags = gameObject.hideFlags | HideFlags.HideInHierarchy;
